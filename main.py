...
class Prey(Organism):
    ...
    def is_prey_adjacent(self, ecosystem: 'Ecosystem') -> bool:
...
class Predator(Organism):
    ...
    def update_state(self, ecosystem: 'Ecosystem'):
        ...
        elif self.starvation_time >= self.max_starvation_time:
            self.health = 0



    def reproduces(self, ecosystem: 'Ecosystem'):
        reproduce = [True, False]
        random.shuffle(reproduce)
    ...
    def move(self, ecosystem: 'Ecosystem'):
        ...
        if visible_prey:
            ...
            positions = self.get_empty_adjacent_row(ecosystem)
            if positions:
                new_x, new_y = positions[0]
                ecosystem.move_organism(self, new_x, new_y)
    ...
    def get_empty_adjacent_row(self, ecosystem):
        return self.check_directions(ecosystem, [(0,1),(0,-1)], 0, [])
    
    def get_empty_adjacent(self, ecosystem):
        return self.check_directions(ecosystem, [(0, 1), (0, -1), (1, 0), (-1, 0)], 0, [])
...
if __name__ == "__main__":
    eco = Ecosystem(size=10, max_cycles=30)
    eco.run_simulation()